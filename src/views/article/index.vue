...
export default {
	...
	mounted() {
		this.$refs.articleMain.style.minHeight = document.querySelector('body').offsetHeight - document.querySelector('.nav').offsetHeight - document.querySelector('.footer-container').offsetHeight + 'px'
	}
};
</script>
